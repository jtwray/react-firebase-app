                ...
                <div className="card-body">
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="text" className="form-control" id="email-address" aria-describedby="email-address-help" placeholder="Your full name" value={data.emailAddress} onChange={(e) => {
                                setData({
